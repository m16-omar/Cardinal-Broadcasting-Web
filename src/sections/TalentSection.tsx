...
export const TalentSection: React.FC = () => {
  ...
  return (
    <section className="py-24 md:py-32 relative bg-slate-100/60 dark:bg-[#07080D] border-t border-b border-slate-200 dark:border-white/5 overflow-hidden transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="relative rounded-3xl overflow-hidden border border-slate-200 dark:border-white/10 shadow-xl dark:shadow-2xl">
              ...
              <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-white/95 dark:bg-[#0E1017]/90 backdrop-blur-xl border border-slate-200 dark:border-white/10 flex items-center gap-3.5 shadow-md">
                <div className="w-10 h-10 rounded-xl bg-purple-100 dark:bg-[#7C3AED]/20 border border-purple-200 dark:border-[#7C3AED]/40 flex items-center justify-center text-purple-700 dark:text-[#A78BFA] shrink-0">
