...
export const CareersPage: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Culture & Values */}
      <section className="py-24 relative bg-[#08090E]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {careerValues.map((v) => (
              <div
                key={v.title}
                className="p-7 rounded-2xl bg-[#0E1017] border border-white/10 space-y-3"
              >
                ...
                <p className="text-xs text-slate-400 leading-relaxed font-normal">{v.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-24 bg-[#0B0D14] border-t border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {careerOpenings.map((job) => (
              <div
                key={job.id}
                className="p-8 rounded-3xl bg-[#0E1017] border border-white/10 hover:border-[#D92039]/40 transition-all duration-300 shadow-xl flex flex-col justify-between space-y-6"
              >
                <div className="space-y-4">
                  <div className="flex flex-wrap items-center gap-2">
                    <span className="px-3 py-1 rounded-full text-xs font-semibold bg-[#9B111E]/15 border border-[#9B111E]/30 text-[#D92039]">
                      {job.department}
                    </span>
